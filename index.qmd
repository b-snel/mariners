...
**Hitters: results vs expectation.** Right of the gates = out-performing their
batted-ball profile (regression candidates down); left = under-performing (due for
positive regression). Higher up = more plate appearances behind the gap.

```{r volcano, fig.width = 9, fig.height = 6}
chart_volcano(batting)
```
